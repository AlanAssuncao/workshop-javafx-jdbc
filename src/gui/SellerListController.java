...
public class SellerListController implements Initializable, DataChangeListener {
	...
	public void createDialogForm (Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			dialogStage.setTitle("Entre com os dados do(a) vendedor(a)");
			...
			Alerts.showAlert("IO Exception", "Error ao carregar a tela", e.getMessage(), AlertType.ERROR);
		}
	}
	...
	private void removeEntity(Seller obj) {
		...
		if (result.get() == ButtonType.OK) {
			...
			try {
				...
				Alerts.showAlert("Erro ao remover o departamento", "O departamento contem vendedores", null, AlertType.ERROR);
			}
		}
	}
}
